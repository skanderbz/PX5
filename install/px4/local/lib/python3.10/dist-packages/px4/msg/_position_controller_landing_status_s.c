...
bool px4__msg__position_controller_landing_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._position_controller_landing_status.PositionControllerLandingStatus", full_classname_dest, 75) == 0);
  }
  px4__msg__PositionControllerLandingStatus * ros_message = _ros_message;
  {  // timestamp
...
PyObject * px4__msg__position_controller_landing_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._position_controller_landing_status");
