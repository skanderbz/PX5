...
bool px4__msg__esc_report__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * px4__msg__esc_report__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool px4__msg__esc_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._esc_status.EscStatus", full_classname_dest, 29) == 0);
  }
  px4__msg__EscStatus * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // esc
    ...
    Py_ssize_t size = 8;
    px4__msg__EscReport * dest = ros_message->esc;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!px4__msg__esc_report__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * px4__msg__esc_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._esc_status");
  ...
  {  // esc
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = px4__msg__esc_report__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
