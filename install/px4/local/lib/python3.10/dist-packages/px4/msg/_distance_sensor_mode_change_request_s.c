...
bool px4__msg__distance_sensor_mode_change_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._distance_sensor_mode_change_request.DistanceSensorModeChangeRequest", full_classname_dest, 76) == 0);
  }
  px4__msg__DistanceSensorModeChangeRequest * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4__msg__distance_sensor_mode_change_request__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of DistanceSensorModeChangeRequest */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._distance_sensor_mode_change_request");
  ...
  px4__msg__DistanceSensorModeChangeRequest * ros_message = (px4__msg__DistanceSensorModeChangeRequest *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
