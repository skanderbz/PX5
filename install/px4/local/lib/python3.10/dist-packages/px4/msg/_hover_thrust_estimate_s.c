...
bool px4__msg__hover_thrust_estimate__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._hover_thrust_estimate.HoverThrustEstimate", full_classname_dest, 50) == 0);
  }
  px4__msg__HoverThrustEstimate * ros_message = _ros_message;
  {  // timestamp
...
PyObject * px4__msg__hover_thrust_estimate__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._hover_thrust_estimate");
