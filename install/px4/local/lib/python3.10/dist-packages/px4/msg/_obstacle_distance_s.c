...
bool px4__msg__obstacle_distance__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._obstacle_distance.ObstacleDistance", full_classname_dest, 43) == 0);
  }
  px4__msg__ObstacleDistance * ros_message = _ros_message;
  {  // timestamp
...
PyObject * px4__msg__obstacle_distance__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._obstacle_distance");
