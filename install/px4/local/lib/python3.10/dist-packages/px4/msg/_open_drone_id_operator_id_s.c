...
bool px4__msg__open_drone_id_operator_id__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._open_drone_id_operator_id.OpenDroneIdOperatorId", full_classname_dest, 56) == 0);
  }
  px4__msg__OpenDroneIdOperatorId * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4__msg__open_drone_id_operator_id__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of OpenDroneIdOperatorId */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._open_drone_id_operator_id");
  ...
  px4__msg__OpenDroneIdOperatorId * ros_message = (px4__msg__OpenDroneIdOperatorId *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
