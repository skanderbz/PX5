...
bool px4__msg__figure_eight_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._figure_eight_status.FigureEightStatus", full_classname_dest, 46) == 0);
  }
  px4__msg__FigureEightStatus * ros_message = _ros_message;
  {  // timestamp
...
PyObject * px4__msg__figure_eight_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._figure_eight_status");
